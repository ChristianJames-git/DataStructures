...
public class PQ2_Grader {
    public static void main(String[] args) {
        PriorityQueue<Integer> pq = new UnorderedLinkedListPriorityQueue<>();
        ...
        pq.clear();
        pq = new UnorderedLinkedListPriorityQueue<>();
        try {
            for (int i = 0; i < 100; i++)
        ...
        try {
            PriorityQueue<Item> pq2 = new UnorderedLinkedListPriorityQueue<>();
        ...
        try {
            ...
            if (pq2.size() != 10)
                System.out.println("Size error, should be 10 but is " + pq2.size());
            for (Item x : pq2) System.out.println(x);
            System.out.println("\n");
